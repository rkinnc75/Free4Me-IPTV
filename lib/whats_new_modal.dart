...
const _changelog = <String, List<String>>{
  ...
  '4.1.62': [
    'Documentation: the README now reflects the current feature set '
        ...
        'preview, diagnostics, and more). No behavior change.',
  ],
  '4.1.61': [
    'Channels start faster on phones: the app now begins connecting the '
        'moment your finger touches a channel, trims duplicate setup work '
        'before playback, and adds two optional Developer tunables for '
        'even quicker live-stream startup.',
  ],
  '4.1.60': [
  ...
  '4.1.42': [
    'This build delivers several improvements that a build-system issue had held '
        ...
        'from the guide, and TV polish for Recordings and the program guide.',
  ],
  '4.1.41': [
    'Guide (TV): the show that\'s on now gets a LIVE badge, already-finished shows are dimmed, and the timeline shows a NOW marker.',
  ],
  '4.1.40': [
    'Polish (TV): Recordings now shows each item as a card matching the rest of the app.',
  ],
  '4.1.39': [
  ...
  '4.1.38': [
    'Stability: on a very long uninterrupted viewing session the audio and '
        ...
        'silently re-syncs itself.',
  ],
  '4.1.37': [
    'Polish (TV): the Search box now has a subtle glass background and shows '
        'your accent color when selected.',
  ],
  '4.1.36': [
    'New look for History (TV): your recently-watched channels now show as a '
        'poster grid like Movies and Series, instead of the old phone layout.',
  ],
  '4.1.35': [
    'Polish (TV): switching channels now shows a clean fade instead of a brief '
        'flash of the previous channel.',
  ],
  '4.1.34': [
    'Polish (TV): the on-screen player controls now fade in and out smoothly '
        'instead of snapping on/off.',
  ],
  '4.1.33': [
    'Polish (TV): the Settings menu highlight now matches your chosen accent '
        'color instead of always being blue.',
  ],
  '4.1.32': [
  ...
  '4.1.31': [
    ...
    'Player controls (TV): Playback speed for movies & catch-up — 0.25× to 2× '
        '(1× is normal). Live channels are unaffected.',
  ],
  '4.1.30': [
  ...
  '4.1.29': [
    'TV design refresh: the EPG guide now tints each channel row by its source '
        ...
        'that source color instead of a plain grey box — so it\'s easier to see '
        'at a glance which provider a channel comes from. (Phone UI unchanged.)',
  ],
  '4.1.28': [
  ...
  '4.1.27': [
    'Fixed: leaving the Settings screen while "Re-match all channels" or a '
        ...
        'only the first source). It now keeps running in the background to '
        'completion, so you can navigate away freely.',
  ],
  '4.1.26': [
    'On TV, multi-view now shows the same accent focus outline as the rest of '
        'the app when you move between the video cells. (Phone UI is unchanged.)',
  ],
  '4.1.25': [
  ...
  '4.1.23': [
    'New on TV: pick your accent color. Settings ▸ Playback ▸ Accent color lets '
        ...
        'and Green — it recolors the whole interface instantly. (Phone UI is '
        'unchanged.)',
  ],
  '4.1.22': [
  ...
  '4.1.19': [
    'TV player controls now lift and highlight when focused (a clean accent '
        ...
        'work exactly as before — open the controls with OK as always. (Phone '
        'UI is unchanged.)',
  ],
  '4.1.18': [
  ...
  '4.1.13': [
    'TV Guide now colour-codes what\'s on: the show currently airing gets a '
        ...
        'so you can spot the kind of programme at a glance. (Phone UI is '
        'unchanged.)',
  ],
  '4.1.12': [
  ...
  '4.1.11': [
    'TV Guide no longer shows blank rows: channels without a program guide '
        ...
        'of an empty grid, so the guide never looks broken. (Phone UI is '
        'unchanged.)',
  ],
  '4.1.10': [
    'TV Guide is easier to read at a glance: the "now" line has a soft glow, '
        'and the show that\'s currently on fills in from the left to show how '
        'far through it is — a built-in progress bar. Times, layout, live '
        'preview and hold-OK menu are unchanged. (Phone UI is unchanged.)',
  ],
  '4.1.9': [
  ...
  '4.1.8': [
    'TV look refresh continues: channel, movie, series and category tiles now '
        ...
        '(replacing the old yellow box) — consistent with the tabs. Everything '
        'else about the tiles is unchanged. (Phone UI is unchanged.)',
  ],
  '4.1.7': [
  ...
  '4.1.3': [
    'Faster EPG (guide) updates, especially when little changed: the app now '
        ...
        'since last time, and only stores programmes for channels you actually '
        'carry. Big drop in refresh time on large playlists.',
  ],
  '4.1.2': [
  ...
  '2.2.50': [
    'TV: pressing OK in a movie or series now opens the same remote-friendly '
        ...
        '— instead of controls the remote could not reach.',
  ],
  '2.2.49': [
  ...
  '2.2.30': [
    'Fixed a bug that could corrupt the search index during a refresh of all '
        ...
        'index is now updated in the correct, safe order per source.',
    'Added automatic recovery: if the search index is found to be corrupted, '
        'the app now rebuilds it and retries the refresh instead of failing.',
  ],
  '2.2.29': [
  ...
  '2.2.26': [
    'Fixed a rare crash where the app could close during an EPG refresh that '
        ...
        'write-ahead log at the right time, removing the heavy disk operation '
        'that could end the app.',
  ],
  '2.2.25': [
  ...
  '2.2.23': [
    'Developer options now has a "Run Search Perf Test" button: it benchmarks '
        ...
        'shows how each performs, and lets you switch to the fastest one with a '
        'tap.',
  ],
  '2.2.22': [
  ...
  '2.2.11': [
    'Program guide stays current: the app now refreshes the EPG on launch when '
        ...
        'guide — so "On now" and the guide grid keep showing live data instead of '
        'going blank.',
    'TV search: after you type, press Down to jump straight to the first result '
        'card.',
    'TV Live guide: hold OK/Select on a channel to open its menu — including '
        '"Open in Multi-view" — without needing a touchscreen.',
  ],
  '2.2.10': [
    'TV Live guide: focus now reliably lands on the first channel when you open a '
        'category, and returns to that category when you press Left (fixes focus '
        'jumping to the top menu).',
  ],
  '2.2.9': [
    'TV Live guide: fixed focus when switching the left list — choosing a '
        'category now reliably lands on the first channel, and pressing Left on a '
        'channel returns to the category you were in.',
  ],
  '2.2.8': [
  ...
  '2.1.6': [
    'TV: fixed a problem introduced in 2.1.5 where the remote D-pad could stop '
        ...
        'and OK to play or pause work reliably again.',
  ],
  '2.1.5': [
    'TV: after pressing OK to bring up the player controls, the D-pad now moves '
        'between the on-screen buttons (cast, picture-in-picture, subtitles, audio, '
        'aspect) and OK activates the highlighted one. Press Back to return to '
        'channel and seek control.',
  ],
  '2.1.4': [
    'TV: channel Up and Down on the remote now work when you start a channel from '
        'the guide (previously they did nothing there), and OK now brings up the '
        'on-screen controls as well as playing or pausing.',
  ],
  '2.1.3': [
