...
const tvBrowseDwellPreviewProp = "tvBrowseDwellPreview"; // fix589 (#5)
...
class SettingsService {
  ...
  static Future<Settings> _readFromDb() async {
    ...
    final bdp = settingsMap[tvBrowseDwellPreviewProp]; // fix589 (#5)
    if (bdp != null) settings.tvBrowseDwellPreview = int.parse(bdp) == 1;
  ...
  static Future<void> updateSettings(Settings settings) async {
    ...
    settingsMap[tvBrowseDwellPreviewProp] =
        (settings.tvBrowseDwellPreview ? 1 : 0).toString(); // fix589 (#5)
