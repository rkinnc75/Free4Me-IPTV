...
const oledBlackProp = "oledBlack"; // fix726 (OLED-black bg)
...
class SettingsService {
  ...
  static Future<Settings> _readFromDb() async {
    ...
    var oledBk = settingsMap[oledBlackProp]; // fix726
    ...
    if (oledBk != null) settings.oledBlack = oledBk == 'true'; // fix726
  ...
  static Future<void> updateSettings(Settings settings) async {
    ...
    settingsMap[oledBlackProp] = settings.oledBlack.toString(); // fix726
